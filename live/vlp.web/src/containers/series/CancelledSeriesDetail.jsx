...
class CancelledSeriesDetail extends Component {
    constructor(props) {
        super(props);
    ...
    getSeriesData = () => {
        ...
        apiService.post('UNAUTHORIZEDDATA', { "data": data, "keyName": "GetCancelledSeriesDetail" })
            .then(response => {
                if (response.Success) {
                                ...
                                <div className="row">
                                    <div className="col-lg-8 col-md-7 col-sm-7">
                                        <div className="bannerTitle">
                                            <h1>Cancelled Series Details</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="breadcrumbSection">
                                            <ul>
                                                ...
                                                <li><a>Cancelled Series Details</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledSeriesDetail);
