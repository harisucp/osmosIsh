                                        ...
                                        <div className="panel-group background-container" id="accordion02">
                                            <div className="panel panel-default">
                                                ...
                                                <div id="collapse011" className="panel-collapse collapse in">
                                                    <div className="panel-body">
                                                        We are looking to grow our community and need your help getting people to host classes online!  If you are able to bring hosts onboard, we are offering 3% of that host's revenue for the <strong>entire year of {year}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="panel panel-default">
