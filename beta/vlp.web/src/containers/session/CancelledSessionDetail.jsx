...
import RelatedSession from "./RelatedSessions";
...
// import { commonFunctions } from "../../shared/components/functional/commonfunctions";
class CancelledSessionDetail extends Component {
    constructor(props) {
        super(props);
    ...
    getSessionData = () => {
        ...
        apiService.post('UNAUTHORIZEDDATA', {
            "data": data,
            "keyName": "GetCancelledSessionDetail"
        })
            .then(response => {
                if (response.Success) {
    ...
    render() {
        const { loading, sessionData, sessionId, tutorId, userMode, isAdded } = this.state;
                                ...
                                <div className="row">
                                    <div className="col-lg-8 col-md-7 col-sm-7">
                                        <div className="bannerTitle">
                                            <h1>Cancelled Session Details</h1>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="breadcrumbSection">
                                            <ul>
                                                ...
                                                <li><a>Cancelled Session Details</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <div className="SessionContent">
                                            ...
                                            {(() => {
                                                ...
                                                if (auth.loggedIn && userMode === "student" && sessionData.EnrollmentId === null && moment().isBefore(commonFunctions.getUtcDatetime(sessionData.StartTime), 'second')) {
                                                ...
                                                else if (auth.loggedIn && userMode === "student" && sessionData.EnrollmentId > 0) {
                                                    return < div className="enrollNow">
                                                        {(() => {
                                                ...
                                                else if (auth.loggedIn === false && isAdded === false && commonFunctions.getUtcDatetime(sessionData.StartTime) > new Date()) {
                                                    return < div className="enrollNow">
                                                        {sessionData.NumberOfJoineesAllowed > sessionData.NumberOfJoineesEnrolled &&
                                                            <button className="btn btn-blue" onClick={() => this.handleEnrollSession(sessionId, sessionData.RefrenceType)} >Add To Cart</button>
                                                        }
...
export default connect(mapStateToProps, mapDispatchToProps)(CancelledSessionDetail);
