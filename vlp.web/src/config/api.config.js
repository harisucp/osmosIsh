...
const API_ENDPOINTS = {
    ...
    PROCESSTUTORCANCELLEDSTUDENTREFUND: "/PaymentAPI/ProcessTutorCancellationRefund",
    CREATEUPDATEPRIVATESESSIONAVAILABLESLOTS: "/SessionAPI/CreateUpdatePrivateSessionAvailableSlots",
